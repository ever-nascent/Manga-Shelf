...
const PATHS = {
	...
	pause: '<rect x="7.5" y="5.5" width="3.2" height="13" rx="1" fill="currentColor" stroke-width="1.2"/><rect x="13.3" y="5.5" width="3.2" height="13" rx="1" fill="currentColor" stroke-width="1.2"/>',
